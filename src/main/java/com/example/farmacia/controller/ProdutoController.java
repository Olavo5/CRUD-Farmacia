...
public class ProdutoController {
	 @Autowired
	    ...
	    public ResponseEntity<List<Produto>> getByExpiration(@PathVariable LocalDate validade){
	        return ResponseEntity.ok(produtoRepository.findByValidadeBefore(validade));
	    }
